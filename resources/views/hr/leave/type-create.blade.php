    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="col">
                ...
                <div class="text-muted mt-1">Add a new leave type to the system</div>
            </div>
            ...
            <form action="#" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Enter leave type name" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label required">Default Days</label>
                        <input type="number" class="form-control" name="default_days" min="0" step="0.5" placeholder="Enter default days allocation" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-selectgroup">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="requires_approval" value="1" class="form-selectgroup-input" checked>
                                <span class="form-selectgroup-label">Yes</span>
                            </label>
                            <label class="form-selectgroup-item">
                                <input type="radio" name="requires_approval" value="0" class="form-selectgroup-input">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-selectgroup">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="paid" value="1" class="form-selectgroup-input" checked>
                                <span class="form-selectgroup-label">Yes</span>
                            </label>
                            <label class="form-selectgroup-item">
                                <input type="radio" name="paid" value="0" class="form-selectgroup-input">
                                <span class="form-selectgroup-label">No</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-selectgroup">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="carry_forward" value="1" class="form-selectgroup-input">
                                <span class="form-selectgroup-label">Yes</span>
                            </label>
                            <label class="form-selectgroup-item">
                                <input type="radio" name="carry_forward" value="0" class="form-selectgroup-input" checked>
                                <span class="form-selectgroup-label">No</span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" name="carry_forward_days" min="0" value="0" disabled>
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label">Description</label>
                    <textarea class="form-control" name="description" rows="3" placeholder="Enter description of this leave type"></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-selectgroup">
                        <label class="form-selectgroup-item">
                            <input type="radio" name="documentation_required" value="1" class="form-selectgroup-input">
                            <span class="form-selectgroup-label">Yes</span>
                        </label>
                        <label class="form-selectgroup-item">
                            <input type="radio" name="documentation_required" value="0" class="form-selectgroup-input" checked>
                            <span class="form-selectgroup-label">No</span>
                        </label>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-selectgroup">
                        <label class="form-selectgroup-item">
                            <input type="radio" name="applicable_to" value="all" class="form-selectgroup-input" checked>
                            <span class="form-selectgroup-label">All Employees</span>
                        </label>
                        <label class="form-selectgroup-item">
                            <input type="radio" name="applicable_to" value="specific" class="form-selectgroup-input">
                ...
                <div class="mb-3" id="departmentsSection" style="display: none;">
                    ...
                    <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                        <label class="form-selectgroup-item flex-fill">
                            <input type="checkbox" name="departments[]" value="production" class="form-selectgroup-input">
                        ...
                        <label class="form-selectgroup-item flex-fill">
                            <input type="checkbox" name="departments[]" value="finance" class="form-selectgroup-input">
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                                <div class="me-3">
                                    <span class="form-selectgroup-check"></span>
                                </div>
                        ...
                        <label class="form-selectgroup-item flex-fill">
                            <input type="checkbox" name="departments[]" value="hr" class="form-selectgroup-input">
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                                <div class="me-3">
                                    <span class="form-selectgroup-check"></span>
                                </div>
                        ...
                        <label class="form-selectgroup-item flex-fill">
                            <input type="checkbox" name="departments[]" value="sales" class="form-selectgroup-input">
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                                <div class="me-3">
                                    <span class="form-selectgroup-check"></span>
                                </div>
                        ...
                        <label class="form-selectgroup-item flex-fill">
                            <input type="checkbox" name="departments[]" value="warehouse" class="form-selectgroup-input">
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                                <div class="me-3">
                                    <span class="form-selectgroup-check"></span>
                                </div>
